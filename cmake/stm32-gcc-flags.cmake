...
set(CMAKE_C_FLAGS "${MCU_FLAGS} -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -std=gnu99 -Wall -fdata-sections -ffunction-sections ${DBG_FLAGS} " CACHE INTERNAL "C compiler flags")
...
set(CMAKE_CXX_FLAGS "${MCU_FLAGS} -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -fno-rtti -fno-exceptions -fno-builtin -Wall -fdata-sections -ffunction-sections ${DBG_FLAGS} " CACHE INTERNAL "Cxx compiler flags")
